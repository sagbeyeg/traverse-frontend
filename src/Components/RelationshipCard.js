    ...
    return (
      <Card class="relationship-cards">
        <Card.Content>
          ...
          <Card.Header><Button class="follow-button" primary floated='right' onMouseEnter={(e) => e.target.textContent = "Unfollow"} onMouseLeave={(e) => e.target.textContent = "Following"}>Following</Button>
            {user.name} 
          </Card.Header>
          <Card.Meta>
            @{user.username}
