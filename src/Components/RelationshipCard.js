  ...
  render() {
    ...
    return (
      <Card class="relationship-cards">
        <Card.Content>
          <Image id={user.id} onClick={this.renderUser} style={{cursor: 'pointer'}} floated='left'
          ...
          <Card.Header id={user.id} onClick={this.renderUser} style={{cursor: 'pointer'}}>
            {user.name} 
          </Card.Header>
          <Card.Meta id={user.id} onClick={this.renderUser} style={{cursor: 'pointer'}}>
            @{user.username}
          </Card.Meta>
