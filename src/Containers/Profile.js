      ...
      <div className="profile">
        ...
        <Grid columns={2} divided centered >
          <Grid.Row stretched>
            ...
            <Grid.Column className="location-cards">
              <Segment>
                <Header icon>
                  <Icon color='blue' name='travel' />
                </Header> 
                <Card.Group centered>
                  {user.reviews? user.reviews.slice(0, 2).map((review, idx) => <Review review={review} key={idx}/> ) : null }
                </Card.Group> 
                <br></br>
              ...
              <Segment>
                ...
                <Card.Group centered>
                  {user.trips? user.trips.slice(0, 2).map((trip, idx) => <Trip trip={trip} key={idx}/> ) : null }
                </Card.Group>
                <br></br>
