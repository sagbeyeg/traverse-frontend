...
import { Button, Grid, Segment, Image, Header, Icon } from 'semantic-ui-react'
        ...
        <Grid columns={2} divided centered>
          <Grid.Row stretched>
            ...
            <Grid.Column>
              <Segment>
                {/* {console.log(user)} */}
                {console.log(user.reviews.map(review => review.title))}
                {user.reviews.map(review => review.title)}
                {/* { user.reviews.map((review, idx) => <ReviewList review={review} key={idx}/> ) } */}
              </Segment>
              <Segment >
                <h1>Favorite Locations</h1>
                <h3>You Have No Favorite Locations Yet</h3>
                {/* <br></br> */}
                <Button primary as={NavLink} to="/locations">Browse Locations</Button>
              </Segment>
              <Segment placeholder>
                <Header icon>
                  <Icon name='house' />
